...
- **Window detection rebuilt** — no more random freezes after alt-tabbing
...
<!-- Add your own screenshots here after launching the app -->
<!-- Example: ![screenshot](https://github.com/YOUR_USERNAME/Chione/assets/...) -->
