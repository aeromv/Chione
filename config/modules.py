...
modules = {
    "LeftClicker": {
        ...
        "checkbox_default1": True,
        "checkbox_text2": "Break Blocks ⚠",
        "checkbox_tooltip2": "Allow for breaking blocks while clicking.",
        "checkbox_default2": False,
        "checkbox_text3": "Allow while Shifting",
        "checkbox_tooltip3": "Allow clicking even when holding shift (crouch) in game.",
        "checkbox_default3": True,
        "params": ["get_slider_value", "get_slider_value", "get_slider_value", "get_slider_value", "get_checkbox_value", "get_checkbox_value", "get_checkbox_value"], 
    ...
    "RightClicker": {
        ...
        "checkbox_text3": "Ignore while Shifting",
        "checkbox_tooltip3": "Stop right-clicking when holding shift (crouch).",
        "checkbox_text4": "Ignore while Left Clicking",
        "checkbox_tooltip4": "Stop right-clicking while left mouse button is held.",
        "checkbox_text5": "Allow in Menus while Shifting",
        "checkbox_tooltip5": "Allow right-clicking in menus/inventories only when holding shift.",
        "params": ["get_slider_value", "get_slider_value", "get_slider_value", "get_checkbox_value", "get_checkbox_value", "get_checkbox_value", "get_checkbox_value", "get_checkbox_value"], 
    ...
    "Others": {
        ...
        "label_text3": "GitHub:\n'AeroMV'",
        "label_link3": "https://github.com/AeroMV"
    }
}